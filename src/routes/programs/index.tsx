...
const PROGRAMS = [
  ...
  },
  {
    ...
    description:
      "Master the core VA skills — inbox management, scheduling, client tools — and land your first remote role in 6 weeks.",
    badge: "Enrolling Now",
    badgeVariant: "gold" as const,
    cta: "View Program",
    href: "/programs/general-virtual-assistant",
    available: true,
  },
  {
    id: "ai-automation",
            ...
            {PROGRAMS.map((p) => (
              ...
              >
                ...
                <div className="mt-6">
                  {p.available ? (
                    <Link
                      to={p.href as "/va-blueprint" | "/programs/general-virtual-assistant"}
