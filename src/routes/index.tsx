...
const DESCRIPTION =
  "HirePath Solutions helps you discover in-demand career paths, learn practical skills, build your CV and portfolio, and get hired. Lagos, Nigeria.";
        ...
        <div className="mx-auto max-w-5xl px-5 py-20 sm:px-8 sm:py-24">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center">
            ...
            <div className="space-y-5 text-base leading-relaxed text-graphite">
              <p>
                HirePath Solutions is a Lagos-based career training company built for people who
                are ready to work but don't know where to start. We identify the most in-demand
                skills in the global job market and design practical programs around them.
              </p>
              <p>
              ...
              <p>
                ...
                foreign currency from Lagos, HirePath gives you the roadmap and the support to
                get there.
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-5xl px-5 py-16 sm:px-8">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-3 max-w-md text-sm text-background/60">
              HirePath Solutions · Lagos, Nigeria
            </p>
